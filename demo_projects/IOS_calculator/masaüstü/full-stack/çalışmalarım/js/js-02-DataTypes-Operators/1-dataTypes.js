...
let sayı = 2
let sayı2 =Math.pow(sayı,2)
console.log(sayı2);

let r = 5 
console.log(Math.pow(r,3));
...
const number2 = 10.50123

//?  Math.round Sayının ondalık kısmı 0.5 veya daha büyükse yukarı, 0.5'ten küçükse aşağı yuvarlama işlemi yapar.
console.log(Math.round(number));
console.log(Math.round(number2));

//? Math.ceil() fonksiyonu, bir sayıyı kendinden büyük en küçük tam sayıya (yukarı yuvarlayarak) yuvarlar.
console.log(Math.ceil(number));
console.log(Math.ceil(number2));

//? Math.floor() fonksiyonu, bir sayıyı kendinden küçük en büyük tam sayıya (aşağı yuvarlayarak) yuvarlar.
...
//! variable.tofixed() ondalıklı kısımdan kaç basamak alınacağı belirtilerek kullanılır ama kullanıldıktan sonra sayı stringe dönüşür
console.log(number.toFixed(3));

let number3 = number2.toFixed(5)
console.log(number3);
console.log( typeof number3);

//? Math.max: Bir sayı dizisindeki en büyüğü bulur.
console.log(Math.max(5,3,62,87,2343,5654,65.45,-34))

//? Math.Min: Bir sayı dizisindeki en küçüğü bulur
console.log(Math.min(5,3,62,87,2343,5654,65.45,-34))

//? Math.random Random metodu rastgele bir sayı üretmek için kullanılır. 0-1 arasında bir sayı üretir.
...
console.log(typeof nedirAcaba) // object
//!--------------------------------------
...
//? STRING TO NUMBER
// Number
// parseInt ondalık kısmı almaz
// parseFloat ondalık kısmı da alır
